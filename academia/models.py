...
class Perimetria(models.Model):
    ...
    bicipesdireito = models.FloatField(null=True, blank=True)
    bicipesesquedo = models.FloatField(null=True, blank=True)
    tricipesdireito = models.FloatField(null=True, blank=True)
    tricipesesquerdo = models.FloatField(null=True, blank=True)
    antebracodireito = models.FloatField(null=True, blank=True)
    antebracoesquerdo = models.FloatField(null=True, blank=True)
    coxadireita = models.FloatField(null=True, blank=True)
    coxaesquerda = models.FloatField(null=True, blank=True)
    panturrilhadireta = models.FloatField(null=True, blank=True)
    panturrilhaesquerda = models.FloatField(null=True, blank=True)
    avaliacaofisica = models.OneToOneField(AvaliacaoFisica, editable=False)
